...
# Joint limits
J_MIN = np.array([(-np.pi)/2, (-np.pi)/4, -1.51327, -np.pi, (-np.pi)/6, (-np.pi)*2], dtype=np.float32)
J_MAX = np.array([+np.pi, (+np.pi)/4, +1.51327, +np.pi, (+np.pi)/6, (+np.pi)*2], dtype=np.float32)
